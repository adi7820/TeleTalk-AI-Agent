...
async def run_client(client_name: str, server_url: str, duration_secs: int):
    ...
    stt = RivaSTTService(api_key=os.getenv("NVIDIA_API_KEY"), function_id="c367545c-964a-42b1-b16f-40c262ae3646", model_name="canary-0.6b-turbo-asr")
    
    tts = RivaTTSService(api_key=os.getenv("NVIDIA_API_KEY"), voice_id="Magpie-Multilingual.EN-US.Sofia", function_id="877104f7-e885-42b9-8de8-f6e4c6303969", push_silence_after_stop=True)
